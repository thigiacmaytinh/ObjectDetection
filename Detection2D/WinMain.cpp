...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	Mat img_object = imread(argv[2], IMREAD_GRAYSCALE);
	...
	//img_scene = TGMTtransform::ResizeByHeight(img_scene, 600);
	//img_object = TGMTtransform::ResizeByHeight(img_object, 100);
